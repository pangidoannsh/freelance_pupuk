...
const Navbar = ({ actived, scrollY }) => {
    ...
    return (
        <nav className={`flex items-center justify-between py-5 px-8 fixed duration-300 w-full z-50 ${isScrolling ? "bg-white shadow" : "bg-white/0"}`}>
            <div className={`text-4xl font-semibold ${isScrolling ? "text-black" : "text-white"}`}>Logo Here</div>
